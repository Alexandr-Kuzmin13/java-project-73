...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(@Value("${base-url}") final String baseUrl,
                          final UserDetailsService userDetailsServiceField,
                          final PasswordEncoder passwordEncoderField, final JWTHelper jwtHelperField) {
        ...
        this.userDetailsService = userDetailsServiceField;
        this.passwordEncoder = passwordEncoderField;
        this.jwtHelper = jwtHelperField;
    }
